...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/summary-care-record/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/summary-care-record/blob/master/CODE_OF_CONDUCT.md).
...
Successful deployment of the API Proxy requires:
 ...
 1. A *Target Server* named `summary-care-record-target`
 2. A *Key-Value Map* named `scr-variables`, containing any values you might need at proxy runtime
