...
public class InvestigationsMapper implements XmlToFhirMapper {
    ...
    private static final String PERTINENT_CRET_BASE_PATH = "/pertinentInformation2/pertinentCREType[.//UKCT_MT144045UK01.Investigation]";
    ...
    public List<? extends Resource> map(Node document) {
        ...
        for (int i = 0; i < pertinentNodes.getLength(); i++) {
            ...
            NodeList investigationNodes = xmlUtils.getNodeListByXPath(pertinentCREType, INVESTIGATION_BASE_PATH);
