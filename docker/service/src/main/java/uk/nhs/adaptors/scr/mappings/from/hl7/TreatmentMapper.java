...
public class TreatmentMapper implements XmlToFhirMapper {
    ...
    private static final String PERTINENT_CRET_BASE_PATH =
        GP_SUMMARY_XPATH + "/pertinentInformation2/pertinentCREType[.//UKCT_MT144055UK01.Treatment]";
    ...
    private static final String TREATMENT_BASE_PATH = "./component/UKCT_MT144055UK01.Treatment";
    ...
    public List<? extends Resource> map(Node document) {
        ...
        for (var pertinentCREType : getNodesByXPath(document, PERTINENT_CRET_BASE_PATH)) {
            ...
            for (Node node : getNodesByXPath(pertinentCREType, TREATMENT_BASE_PATH)) {
