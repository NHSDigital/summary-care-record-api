...
public class ObservationMapperTest extends BaseFhirMapperTest {
    ...
    private static final String CLINICAL_OBS_FILE_NAME = "example";

    @Test
    public void When_MappingFromInvestigationResultsFHIR_Expect_RootId() {
        var jsonBundle = getFileAsObject(RESOURCE_DIRECTORY, INVESTIGATION_FILE_NAME, Bundle.class);
    ...
    public void When_MappingFromInvestigationResultsFHIR_Expect_MatchingHtml() {
        var expectedHtml = getExpectedHtml(RESOURCE_DIRECTORY, INVESTIGATION_FILE_NAME);
        var jsonBundle = getFileAsObject(RESOURCE_DIRECTORY, INVESTIGATION_FILE_NAME, Bundle.class);
